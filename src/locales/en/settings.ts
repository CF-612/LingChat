...
export default {
  ...
  advanceOther: {
    ...
    autostart: {
      ...
      roleHint: 'The selection is saved automatically; this role will be loaded by default at startup.',
    },
    saveButton: 'Save',
    ...
    subcategoryDescs: {
      ...
      开机自启动:
        'Launch LingChat automatically at startup',
    ...
    fields: {
      ...
      features: {
        ...
        use_persistent_memory:
          'USE_PERSISTENT_MEMORY — When on, memory is auto-compressed to reduce token usage',
        memory_update_interval:
          'MEMORY_UPDATE_INTERVAL — Number of new messages that triggers a memory summary (default 250)',
        memory_recent_window:
          'MEMORY_RECENT_WINDOW — Number of recent messages kept when summarizing (default 30)',
      },
      tts: {
